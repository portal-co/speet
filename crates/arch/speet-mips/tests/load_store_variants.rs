...
fn test_load_store_variants() {
    ...
    recompiler
        .translate_instruction(&mut ctx, &lb, &mut |locals| {
    ...
    recompiler
        .translate_instruction(&mut ctx, &lbu, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &lh, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &lhu, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &sb, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &sh, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &lw, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
    ...
    recompiler
        .translate_instruction(&mut ctx, &sw, &mut |locals| {
            Function::new(locals.collect::<Vec<_>>())
        })
        .unwrap();
}
